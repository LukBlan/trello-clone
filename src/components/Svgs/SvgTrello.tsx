function SvgTrello() {
  return (
    <svg className="h-7 w-6 self-end fill-blue drop-shadow-blue-shadow" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
