import styles from "@/components/Svgs/SvgTrello.module.css"

function SvgTrello() {
  return (
    <svg className={styles.svgTrello} viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
